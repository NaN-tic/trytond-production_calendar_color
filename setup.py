...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-production_calendar_color',
    download_url='https://github.com:nantic/trytond-production_calendar_color.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-production_calendar_color.git'
    },
    classifiers=[
